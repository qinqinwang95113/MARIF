...
#         idx = np.random.randint(len(self.pair))
        ...
        return t.LongTensor(u_seq_ratings), t.LongTensor(item_seq_ids), t.LongTensor(i_seq_ratings), t.LongTensor(user_seq_ids), t.LongTensor(label)
...
#         idx = np.random.randint(len(self.pair))
        ...
        return t.LongTensor(u_seq_ratings), t.LongTensor(i_seq_ratings), t.LongTensor(gender), t.LongTensor(age), t.LongTensor(occupation), t.LongTensor(zipCode), t.LongTensor(genres), t.LongTensor(label)
...
#         idx = np.random.randint(len(self.pair))
        ...
        return t.LongTensor(u_seq_ratings), t.LongTensor(item_seq_ids), t.LongTensor(i_seq_ratings), t.LongTensor(user_seq_ids), t.LongTensor(style), t.LongTensor(price), t.LongTensor(label)  
...
#         idx = np.random.randint(len(self.pair))
        ...
        return t.LongTensor(u_seq_ratings), t.LongTensor(item_seq_ids), t.LongTensor(i_seq_ratings), t.LongTensor(user_seq_ids), t.LongTensor(genres), t.LongTensor(label)
